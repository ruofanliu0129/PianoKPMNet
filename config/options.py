...
class Options():
    ...
    def initialize(self, eval):
        ...
        self.parser.add_argument('--dataroot', '-d', default='./dataset',
                                 help='Dataset path')
    ...
    def add_training_options(self):
        ...
        self.parser.add_argument('--epoch', type=int, default=1,
        ...
        self.parser.add_argument('--print_freq', '-pf', type=int, default=5000,
...
class PianoKPMOptions():
    def __init__(self):
        self.parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
        self.parser.add_argument('--name', '-n', default=f"{datetime.now().strftime('%Y-%m-%d/%H-%M-%S')}",
                                 help='Project name under the checkpoints file')
        self.parser.add_argument('--num_threads', '-nt', type=int, default=0,
                                 help='Number of threads when reading data')
        self.parser.add_argument('--is_continue', default=False, action="store_true", help='Training iterations')
        
    def get_options(self, is_train):
        self.opt = self.parser.parse_args()
        self.opt.is_train = is_train
        args = vars(self.opt)
        return self.opt
